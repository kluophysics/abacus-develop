...
namespace Module_ROPT{
    ...
    Element Element::GetFFT2D(int direction) const
    {
        ...
        Vector result(*this);
        realdp *resultptr = result.ObtainWriteEntireData();
        /*Note that Module_ROPT uses column-major and FFTW uses row-major, therefore the
