...
#include <armadillo>
// #define StiefelPoint  ModuleBase:matrix // StiefelPoint is the same as ModuleBase:matrix
// #define StiefelVector  ModuleBase:matrix // StiefelVector is the same as ModuleBase:matrix
...
namespace Module_Optimizer
{
    ...
    // using StiefelPoint=ModuleBase:matrix ;
    ...
    StiefelVector Stiefel::diff_retraction(const StiefelPoint &x, const StiefelVector &etax, const StiefelPoint &y, const StiefelVector &xix)
    {
        ...
        bool equal_dimension(const StiefelPoint& a, const StiefelPoint& b) 
        {
