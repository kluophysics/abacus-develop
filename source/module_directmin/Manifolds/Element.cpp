...
namespace Module_DirectMin{
...
#ifdef Module_DirectMin_WITH_FFTW
    Element Element::GetFFT2D(int direction) const
    {
        ...
        Vector result(*this);
        realdp *resultptr = result.ObtainWriteEntireData();
        /*Note that Module_DirectMin uses column-major and FFTW uses row-major, therefore the
...
}; /*end of Module_DirectMin namespace*/
